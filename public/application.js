...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mapOnLoad = __webpack_require__(7);
	var authEvents = __webpack_require__(23);
	var mapEvents = __webpack_require__(15);
	...
	$(function () {
	  ...
	  $('#chng-pw-modal').on('click', function () {
	    $('#tempChangePasswordError').html('');
	  });
	  $('#chng-pw-modal').on('click', function () {
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://find-my-car-api.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mapFunctions = __webpack_require__(8);
	var store = __webpack_require__(10);
	var icons = __webpack_require__(11);
	var style = __webpack_require__(12);
	var iconHandlers = __webpack_require__(13);
	var alerts = __webpack_require__(14);
	...
	var mapApiCall = function mapApiCall() {
	  GoogleMapsLoader.load(function (google) {
	    // console.log('empty starting')

	    mapFunctions.getCurrentLocation().then(function (position) {
	      var mapStyle = style.styleMap();
	      var map = mapFunctions.initializeMapWithGeo(position, mapStyle);
	      store.map = map;
	      var icon = icons.userIcon();
	      var userIcon = mapFunctions.placeMarker(position, map, icon, true);
	      ...
	      var mapStyle = style.styleMap();
	      var map = mapFunctions.initializeMapNoGeo(mapStyle);
	      store.map = map;
	      var icon = icons.userIcon();
	      var userIcon = mapFunctions.placeMarker({ lat: 42.3601, lng: -71.0589 }, map, icon, true);
	      store.userIcon = userIcon;
	      iconHandlers.signInIconHandlers(userIcon);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var initializeMapWithGeo = function initializeMapWithGeo(position, styledMapType) {
	...
	var initializeMapNoGeo = function initializeMapNoGeo(styledMapType) {
	...
	var placeMarker = function placeMarker(position, map, icon, dragBool, id, time, note, currentBool) {
	  var latLng = void 0;
	...
	var loadMapOverlays = function loadMapOverlays(map) {
	...
	var displayInfoWindow = function displayInfoWindow() {
	...
	module.exports = {
	  initializeMapWithGeo: initializeMapWithGeo,
	  initializeMapNoGeo: initializeMapNoGeo,
	  placeMarker: placeMarker,
	  loadMapOverlays: loadMapOverlays,
	  // geoLocation,
...
/***/ (function(module, exports) {
	...
	var date = function date(dateTime) {
	  var monthHash = {
	    '01': 'January',
	    '02': 'February',
	    '03': 'March',
	  ...
	  var month = monthHash[dateTime.split('').slice(5, 7).join('')];
	  var day = dayHash[dateTime.split('').slice(8, 10).join('')];
	  var year = dateTime.split('').slice(0, 4).join('');
	  var date = month + ' ' + day + ', ' + year;
	  // // console.log(date)
	  return date;
	};

	var time = function time(dateTime) {
	  var hourHash = {
	    '00': { hour: '8', amPm: 'pm' },
	    '01': { hour: '9', amPm: 'pm' },
	    '02': { hour: '10', amPm: 'pm' },
	  ...
	  var hour = hourHash[dateTime.split('').slice(11, 13).join('')]['hour'];
	  // const adjHour = (parseInt(hour) - 4).toString()
	  var amPm = hourHash[dateTime.split('').slice(11, 13).join('')]['amPm'];
	  var min = dateTime.split('').slice(14, 16).join('');
...
/***/ (function(module, exports) {
	...
	var pastParkingIcon = function pastParkingIcon() {
	  return {
	...
	var currentParkingIcon = function currentParkingIcon() {
	  return {
	...
	module.exports = {
	  userIcon: userIcon,
	  pastParkingIcon: pastParkingIcon,
	  currentParkingIcon: currentParkingIcon
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var userIconHandlers = function userIconHandlers(marker) {
	  var userIconDragListener = google.maps.event.addListener(marker, 'dragend', function (e) {
	  ...
	  var userIconClickListener = google.maps.event.addListener(marker, 'click', function (e) {
	...
	var signInIconHandlers = function signInIconHandlers(marker) {
	  var userIconSignInListener = google.maps.event.addListener(marker, 'click', function (e) {
	    // console.log('clicked marker')
	    var mapEvents = __webpack_require__(15);
	    // $('#myParkingModal').modal('toggle')
	...
	var pastCarsIconHandlers = function pastCarsIconHandlers(markerArray) {
	  var pastCarIcons = markerArray;
	  if (pastCarIcons[0]) {
	    var length = pastCarIcons.length;

	    var _loop = function _loop(i) {
	      var pastcarListener = google.maps.event.addListener(pastCarIcons[i], 'click', function (e) {
	...
	var currentCarIconHandlers = function currentCarIconHandlers(marker) {
	  var currentCarIcon = marker;
	  var currentCarListener = google.maps.event.addListener(currentCarIcon, 'click', function (e) {
	...
	module.exports = {
	  userIconHandlers: userIconHandlers,
	  pastCarsIconHandlers: pastCarsIconHandlers,
	  currentCarIconHandlers: currentCarIconHandlers,
	  signInIconHandlers: signInIconHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hideAlerts = function hideAlerts() {
	  $('#sign-out-success-alert-id').hide();
	  $('#sign-out-failure-alert-id').hide();
	  $('#new-parking-spot-failure-alert-id').hide();
	  $('#get-parking-spots-failure-alert-id').hide();
	...
	var showUpdateAlert = function showUpdateAlert(message) {
	  hideAlerts();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var mapApi = __webpack_require__(17);
	var mapUi = __webpack_require__(18);

	var onNewParkingSpot = function onNewParkingSpot() {
	  ...
	  mapApi.newParkingSpot(data).then(mapUi.newParkingSpotSuccess).catch(mapUi.newParkingSpotFailure);

	  // console.log('how about here?')
	};

	var onGetParkingSpots = function onGetParkingSpots() {
	  mapApi.getParkingSpots().then(mapUi.getParkingSpotsSuccess).catch(mapUi.getParkingSpotsFailure);
	};

	var onGetParkingSpot = function onGetParkingSpot() {
	  mapApi.getParkingSpot().then(mapUi.getParkingSpotSuccess).catch(mapUi.getParkingSpotFailure);
	};

	var onDeleteParkingSpot = function onDeleteParkingSpot() {
	  mapApi.deleteParkingSpot().then(mapUi.deleteParkingSpotSuccess).catch(mapUi.deleteParkingSpotFailure);
	};

	var onEditParkingSpot = function onEditParkingSpot() {
	  event.preventDefault();
	  // const note = getFormFields(this).parking_spot.note
	  var note = $('#note').html();
	  ...
	  mapApi.editParkingSpot(data).then(mapUi.editParkingSpotSuccess).catch(mapUi.editParkingSpotFailure);
	};
	...
	module.exports = {
	  onGetParkingSpots: onGetParkingSpots,
	  onGetParkingSpot: onGetParkingSpot,
	  onEditParkingSpot: onEditParkingSpot,
	  addHandlers: addHandlers,
	  onNewParkingSpot: onNewParkingSpot
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var newParkingSpot = function newParkingSpot(data) {
	...
	var getParkingSpot = function getParkingSpot() {
	  return $.ajax({
	...
	var getParkingSpots = function getParkingSpots() {
	  return $.ajax({
	    url: config.apiOrigin + '/parking_spots',
	    method: 'GET',
	    headers: {
	...
	var deleteParkingSpot = function deleteParkingSpot() {
	  return $.ajax({
	...
	var editParkingSpot = function editParkingSpot(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateDrawer = __webpack_require__(21);
	var alerts = __webpack_require__(14);

	var newParkingSpotSuccess = function newParkingSpotSuccess(ajaxResponse) {
	  // $('#myParkingModal').modal('toggle')
	  var mapEvents = __webpack_require__(15);
	...
	var newParkingSpotFailure = function newParkingSpotFailure() {
	  // console.log('parkingSpotFailure')
	  alerts.showUpdateAlert($('#new-parking-spot-failure-alert-id'));
	};

	var getParkingSpotsSuccess = function getParkingSpotsSuccess(ajaxResponse) {
	...
	var getParkingSpotsFailure = function getParkingSpotsFailure() {
	  // console.log('getParkingSpotsFailure')
	  alerts.showUpdateAlert($('#get-parking-spots-failure-alert-id'));
	};

	var getParkingSpotSuccess = function getParkingSpotSuccess(ajaxResponse) {
	  var mapEvents = __webpack_require__(15);
	  // console.log('getParkingSpotSuccess', ajaxResponse)
	  mapEvents.onGetParkingSpots();
	};

	var getParkingSpotFailure = function getParkingSpotFailure() {
	  // console.log('getParkingSpotFailure')
	  alerts.showUpdateAlert($('#get-parking-spot-failure-alert-id'));
	};

	var deleteParkingSpotSuccess = function deleteParkingSpotSuccess() {
	  var mapEvents = __webpack_require__(15);
	...
	var deleteParkingSpotFailure = function deleteParkingSpotFailure() {
	  // console.log('deleteParkingSpotFailure')
	  alerts.showUpdateAlert($('#delete-failure-alert-id'));
	};

	var editParkingSpotSuccess = function editParkingSpotSuccess(ajaxResponse) {
	  var mapEvents = __webpack_require__(15);
	  store.updateDrawer = false;
	...
	var editParkingSpotFailure = function editParkingSpotFailure() {
	  // console.log('editParkingSpotFailure')
	  alerts.showUpdateAlert($('#update-failure-alert-id'));
	};

	module.exports = {
	  newParkingSpotSuccess: newParkingSpotSuccess,
	  newParkingSpotFailure: newParkingSpotFailure,
	  getParkingSpotsSuccess: getParkingSpotsSuccess,
	  getParkingSpotsFailure: getParkingSpotsFailure,
	  getParkingSpotSuccess: getParkingSpotSuccess,
	  getParkingSpotFailure: getParkingSpotFailure,
	  deleteParkingSpotSuccess: deleteParkingSpotSuccess,
	  deleteParkingSpotFailure: deleteParkingSpotFailure,
	  editParkingSpotSuccess: editParkingSpotSuccess,
	  editParkingSpotFailure: editParkingSpotFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var renderPastParkingLocations = function renderPastParkingLocations(ajaxResponse) {
	  ...
	  if (ajaxResponse.parking_spots[0]) {
	    ...
	    var parkingSpotsSorted = ajaxResponse.parking_spots.sort(function (a, b) {
	      return a.id - b.id;
	    });
	    ...
	    var icon = icons.pastParkingIcon();

	    // remove all markers currently on map
	    remove.removePastCarIcons();

	    var length = parkingSpotsSorted.length;
	    for (var i = 0; i < length - 1; i++) {
	      var latitude = parkingSpotsSorted[i].latitude;
	      var longitude = parkingSpotsSorted[i].longitude;
	      var latLng = { lat: latitude, lng: longitude };
	      var pastCar = mapFunctions.placeMarker(latLng, store.map, icon, false, parkingSpotsSorted[i].id, parkingSpotsSorted[i].created_at, parkingSpotsSorted[i].note, false);
	...
	var renderCurrentParkingLocation = function renderCurrentParkingLocation(ajaxResponse) {
	  // if there are no parking_spots in the Ajax response, then don't try to render things
	  // that don't exist.
	  if (ajaxResponse.parking_spots[0]) {
	    ...
	    var length = parkingSpotsSorted.length;
	    var latitude = parkingSpotsSorted[length - 1].latitude;
	    var longitude = parkingSpotsSorted[length - 1].longitude;
	    var latLng = { lat: latitude, lng: longitude };
	    var icon = icons.currentParkingIcon();
	    var currentCar = mapFunctions.placeMarker(latLng, store.map, icon, false, parkingSpotsSorted[length - 1].id, parkingSpotsSorted[length - 1].created_at, parkingSpotsSorted[length - 1].note, true);
	...
	module.exports = {
	  renderCurrentParkingLocation: renderCurrentParkingLocation,
	  renderPastParkingLocations: renderPastParkingLocations
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var removePastCarIcons = function removePastCarIcons() {
	  // remove all markers currently on map
	  if (store.pastMarkersArray) {
	    for (var i = 0; i < store.pastMarkersArray.length; i++) {
	...
	var removeCurrentCarIcon = function removeCurrentCarIcon() {
	...
	module.exports = {
	  removePastCarIcons: removePastCarIcons,
	  removeCurrentCarIcon: removeCurrentCarIcon
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateDrawer = function updateDrawer(marker) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showSignUpModal = function showSignUpModal(event) {
	  // console.log('this should toggle sign-up modal')
	  $('#mySignUpModal').modal('toggle');
	};

	var showSignInModal = function showSignInModal(event) {
	  $('#mySignInModal').modal('toggle');
	};

	var showChangePasswordModal = function showChangePasswordModal(event) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signUpSuccess = function signUpSuccess(ajaxResponse) {
	...
	var signInSuccess = function signInSuccess(ajaxResponse) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var changePasswordError = function changePasswordError() {
